...
import type { SignupDetails } from '@/components/types'
import router from '@/router'
import { ref, type Ref } from 'vue'
import { toast } from 'vue3-toastify'

const userDetails: Ref<SignupDetails> = ref({
  name: '',
  email: '',
  password: ''
})
...
<template>
  <div class="max-w-md mx-auto my-8 p-6 bg-slate-200 shadow-lg rounded-lg">
